...
<head>
    ...
    <title>@yield('judul_halaman', 'Rizki Rental - Rental PS Terbaik')</title>
...
<body class="bg-slate-50 text-slate-800 antialiased selection:bg-[#1e448e] selection:text-white flex flex-col min-h-screen">
    ...
    <nav class="bg-white/90 backdrop-blur-md border-b border-slate-200 shadow-sm sticky top-0 z-50 transition-all duration-300">
        <div class="max-w-6xl mx-auto flex items-center justify-between px-6 py-3.5">
            ...
            <div class="hidden md:flex items-center space-x-6 font-bold text-sm">
                <a class="text-[#1e448e] hover:text-slate-500 transition-colors" href="{{ url('/#status') }}">Status Unit</a>
                <a class="text-[#1e448e] hover:text-slate-500 transition-colors" href="{{ url('/#harga') }}">Pricelist</a>
                <a class="text-[#1e448e] hover:text-slate-500 transition-colors" href="{{ url('/#fasilitas') }}">Fasilitas</a>
                <a class="text-[#1e448e] hover:text-slate-500 transition-colors" href="{{ url('/#lokasi') }}">Lokasi</a>
    ...
    <footer class="bg-[#15233c] text-slate-300 py-12 border-t-[6px] border-[#1e448e] relative overflow-hidden mt-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
                ...
                <div class="md:col-span-3">
                    ...
                    <ul class="space-y-3 font-bold text-slate-400 text-sm">
                        <li><a href="{{ url('/#status') }}" class="hover:text-blue-300 transition-colors">❯ Status Unit</a></li>
                        <li><a href="{{ url('/#harga') }}" class="hover:text-blue-300 transition-colors">❯ Paket & Pricelist</a></li>
                        <li><a href="{{ url('/#fasilitas') }}" class="hover:text-blue-300 transition-colors">❯ Fasilitas Kami</a></li>
                        <li><a href="{{ url('/#lokasi') }}" class="hover:text-blue-300 transition-colors">❯ Peta Lokasi</a></li>
                    </ul>
                </div>
